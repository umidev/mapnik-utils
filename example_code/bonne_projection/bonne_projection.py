...
m = Map(1500,1700,'+proj=bonne +lon_0=0 +lat_1=90 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs')
m.background = Color('#D82815')
s,r = Style(),Rule()
r.symbols.append(PolygonSymbolizer(Color('#FC8D59')))
r.symbols.append(LineSymbolizer(Color('#88000F'),.7))
s.rules.append(r)
...
s,r = Style(),Rule()
r.symbols.append(LineSymbolizer(Color('#F0E5E3'),1))
s.rules.append(r)
...
m.layers.append(lyr)
#m.zoom_all()
m.zoom_to_box(Envelope(-12996966,-22008607,26348930,11562161))
